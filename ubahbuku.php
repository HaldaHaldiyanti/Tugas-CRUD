...
value="<?php echo $data['judul_buku'] ?>" >
 ...
 <div class="form-group row">
 <label for="pengarang" class="col-sm-1 col-formlabel">Pengarang</label>
 <div class="col-sm-3">
...
value="<?php echo $data['pengarang'] ?>" >
 ...
 <div class="form-group row">
 <label for="tahun_terbit" class="col-sm-1 col-formlabel">Tahun Terbit</label>
 <div class="col-sm-3">
 <input type="number" name="tahun_terbit" class="formcontrol" value="<?php echo $data['tahun_terbit'] ?>" >
 </div>
 </div>
 <div class="form-group row">
 <label for="kategori" class="col-sm-1 col-formlabel">Kategori</label>
 <div class="col-sm-3">
...
mr-0" >Kirim</button>
<a href="index.php" class="btn btn-primary mb-1 mt-1 ml0"><i class="fas fa-user-plus mr-0"></i>Koleksi Buku</a>
</form>
<?php } ?>
 <!-- Optional JavaScript -->
